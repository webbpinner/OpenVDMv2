...
VALUES
  ...
  (7,'cruiseEndDate',''),
  (8,'cruiseSize','0'),
  (9,'cruiseSizeUpdated','1970/01/01 00:00:00'),
  (10,'loweringID',''),
  (11,'loweringStartDate',''),
  (12,'loweringEndDate',''),
  (13,'loweringSize','0'),
  (14,'loweringSizeUpdated','1970/01/01 00:00:00'),
  (15,'systemStatus','Off'),
...
INSERT INTO `OVDM_CruiseDataTransfers` (`cruiseDataTransferID`, `name`, `longName`, `transferType`, `destDir`, `localDirIsMountPoint`, `rsyncServer`, `rsyncUser`, `rsyncPass`, `smbServer`, `smbUser`, `smbPass`, `smbDomain`, `sshServer`, `sshUser`, `sshUseKey`, `sshPass`, `status`, `enable`, `required`, `pid`, `bandwidthLimit`, `includeOVDMFiles`)
VALUES
  (1,'SSDW','Shoreside Data Warehouse',4,'/vault/Shoreside',0,'','','','','','','','127.0.0.1','survey',0,'Tethys337813',2,1,1,0,128,0);
...
VALUES
  (1,'admin','$2y$12$JviETOQPkNzqZxQpswLb1ONtTLxsqdzQJEoaWjlNzb0/.xfIOVM/C','2017-10-03 10:51:37');
