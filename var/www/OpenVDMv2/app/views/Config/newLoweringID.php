    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="panel panel-default">
                <div class="panel-heading">New LoweringID</div>
...
?>
        ...
        <div class="col-lg-6">
            <h3>Page Guide</h3>
            <p>This page is for creating a new loweringID and associated lowering data directory.  This page is NOT for configuring OpenVDM to use a previously created loweringID.  If you are trying to configure OpenVDM to use a previously created loweringID click <a href="<?php echo DIR; ?>config/editLoweringID">here</a>.</p>
