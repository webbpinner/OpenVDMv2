...
def test_sshDestDir(gearman_worker):
    ...
    logger.debug('Write test command: {}'.format(write_test_command))
    ...
    proc = subprocess.Popen(write_cleanup_command, capture_output=True)
