...
#         FILE:  hdt_parser.py
#
#        USAGE:  hdt_parser.py [-h] <dataFile>
#
...
RAW_COLUMNS = ['date','time','hdr','heading','T','checksum']
...
def parseFile(filePath):
	...
	deltaTValidityStat = {'statName':'DeltaT Validity', 'statType':'valueValidity', 'statData':[1 + len(df_proc[(df_proc['deltaT'] <= MAX_DELTA_T)]),len(df_proc[(df_proc['deltaT'] > MAX_DELTA_T)])]}
	...
	decimals = pd.Series([3], index=['heading'])
	...
	visualizerDataObj['label'] = 'Heading, True'
