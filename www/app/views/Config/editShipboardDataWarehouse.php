...
?>
    ...
    <div class="row">
                    ...
                    <?php echo Form::open(array('role'=>'form', 'method'=>'post')); ?>
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    <label>Cruise Data Base Directory</label><?php echo Form::input(array('class'=>'form-control', 'type'=>'text', 'name'=>'shipboardDataWarehouseBaseDir', 'value'=>$data['shipboardDataWarehouseConfig']['shipboardDataWarehouseBaseDir'], 'disabled'=>'disabled')); ?>
                                </div>
                                <div class="form-group">
                                    <label>Cruise Data Apache Directory</label><?php echo Form::input(array('class'=>'form-control', 'type'=>'text', 'name'=>'shipboardDataWarehouseApacheDir', 'value'=>$data['shipboardDataWarehouseConfig']['shipboardDataWarehouseApacheDir'], 'disabled'=>'disabled')); ?>
                                </div>
                                <div class="form-group">
        ...
        <div class="col-lg-6">
            ...
            <p>The <strong>Cruise Data Base Directory</strong> is the location of the parent directory to the Cruise Data Directories on the SBDW (i.e. "/mnt/vault/FTPRoot/CruiseData").  This is defined in the OpenVDM web-application configuration file and can not be edited here.</p>
            <p>The <strong>Cruise Data Apache Directory</strong> is the location of the parent directory to the Cruise Data Directories as defined within the webserver. (i.e. "/CruiseData").  This is defined in the OpenVDM web-application configuration file and can not be edited here.</p>
