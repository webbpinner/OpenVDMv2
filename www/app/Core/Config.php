...
class Config
{
    ...
    public function __construct()
    {
         ...
         */
        define('DASHBOARD_CONF', '/Users/webbpinner/Documents/Computer-Related/GitHub_Repos/OpenVDMv2/usr/local/etc/openvdm/datadashboard.yaml');
         ...
         */
        define('SITETITLE', 'Open Vessel Data Management v2.4');
